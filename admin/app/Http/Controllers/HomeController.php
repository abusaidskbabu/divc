...
class HomeController extends Controller {
	...
	public function index( Request $request,  $category = ''){
		...
		if($page !='') {
			...
			$this->data['allslider'] = Homeslider::all();
			$this->data['upcoming'] = Upcoming::orderBy('id', 'DESC')->get();
			$this->data['ourclients'] = Ourclients::where('status', 1)->orderBy('id', 'DESC')->get();
			$this->data['ourclients'] = Ourclients::orderBy('id', 'DESC')->get();
			$this->data['recentcauses'] = Recentcauses::orderBy('id', 'DESC')->limit(3)->get();
			$this->data['ourgallary'] = Ourgallary::orderBy('id', 'DESC')->get();
			$this->data['testimonials'] = Testimonials::orderBy('id', 'DESC')->get();
			...
			if(count($sql)>=1)
			{
				...
				$this->data['pageID'] = $row->pageID ;
				$this->data['content'] = \PostHelpers::formatContent($row->note);
				$this->data['allslider'] = Homeslider::orderBy('id', 'DESC')->get();
				$this->data['upcoming'] = Upcoming::orderBy('id', 'DESC')->get();
				$this->data['ourvolunteers'] = Ourvolunteers::orderBy('id', 'DESC')->get();
				$this->data['ourclients'] = Ourclients::where('status', 1)->orderBy('id', 'DESC')->get();
				$this->data['recentcauses'] = Recentcauses::orderBy('id', 'DESC')->limit(3)->get();
				$this->data['ourgallary'] = Ourgallary::orderBy('id', 'DESC')->get();
				$this->data['testimonials'] = Testimonials::orderBy('id', 'DESC')->get();
