...
class InvestmentController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('investment');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('investment.public.view',$data);			
			}			
		} 
		else {
			...
			return view('investment.public.index',$data);	
		}
